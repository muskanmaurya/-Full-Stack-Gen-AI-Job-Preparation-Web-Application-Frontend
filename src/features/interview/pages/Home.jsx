...
const Home = () => {
  ...
  const [resumeName, setResumeName] = useState("PDF or DOCX (Max 5MB)")
  const resumeInputRef = useRef()   // Ref for the hidden file input

    const handleResumeChange = (event) => {
        const selectedFile = event.target.files?.[0]
        setResumeName(selectedFile ? selectedFile.name : "PDF or DOCX (Max 5MB)")
    }
  ...
  const handleGenerateReport=async()=>{
    try {
        ...
        console.error("Failed to generate interview report. Check network/server logs.");
    } catch (error) {
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <p className='dropzone__subtitle'>{resumeName}</p>
                                <input
                                    ref={resumeInputRef}
                        ...
                        <div className='info-box'>
                            ...
                            <p>Both a <strong>Resume</strong> and a <strong>Self Description</strong> is required to generate a personalized plan.</p>
                        </div>
                    </div>
                </div>
