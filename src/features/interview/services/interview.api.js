...
export const generateResumePdf=async({interviewReportId, resumePayload})=>{
    const response = await api.post(`/api/interview/resume/pdf/${interviewReportId}`,resumePayload || null,{
        responseType:"blob", 
    })
